		...
		<html lang="en">
			<head>
				...
				<link
					...
					sizes="180x180"
					href={process.env.NEXT_PUBLIC_BASE_URL + '/Favicons/apple-touch-icon.png'}
				/>
				<link
					rel="icon"
					type="image/png"
					sizes="32x32"
					href={process.env.NEXT_PUBLIC_BASE_URL + '/Favicons/favicon-32x32.png'}
				/>
				<link
					rel="icon"
					type="image/png"
					sizes="16x16"
					href={process.env.NEXT_PUBLIC_BASE_URL + '/Favicons/favicon-16x16.png'}
				/>
				<link
					rel="mask-icon"
					href={process.env.NEXT_PUBLIC_BASE_URL + '/Favicons/safari-pinned-tab.svg'}
					color="#5bbad5"
				/>
