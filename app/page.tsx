		...
		<main>
			...
			<section className={styles.containerBanner}>
				<h1 className={styles.willkommen}>
					Herzlich Willkommen <span className={styles.umbruch}>bei xapling</span>
				</h1>
          ...
          WE GROW <br /> SUSTAINABLE <br /> TECHNOLOGY
				...
				<div className={styles.containerText}>
					<article className={styles.containerInnerText1}>
						...
						<p className={styles.pUmbruch}>
							Durch die Erstellung von Lösungen für konforme Software- und Hardwareentwicklung dafür
							sorgen, dass Produkte und Dienstleistungen im Sinne der Bedürfnisse der Menschen,
							ihrer Ernährung und der Erhaltung der Erde und der Natur verwirklicht werden können.
						</p>
						<p className={styles.pUmbruch}>
							Die Basis, um diesen Traum verantwortungsvoll und zuverlässig erfüllen zu können,
							bildet ein kollegiales Team mit Hilfsbereitschaft untereinander und mit Gerechtigkeit
							und Fairness gegenüber Kollegen, Kunden und Lieferanten.
						</p>
					</article>
				</div>
			</section>
			<section className={styles.containerColumn2}>
				<div className={styles.containerText}>
					<article className={styles.containerInnerText2}>
						<p className={styles.pUmbruch}>
							Wir bauen Produkte und Dienstleistungen im Sinne der Menschheit und der Erde und
							sorgen dafür, dass es auch andere tun.{' '}
						</p>
						<p className={styles.pUmbruch}>
							Das machen wir durch die Erstellung von Lösungen für konforme Software- und
							Hardwareentwicklung.
						</p>
					</article>
				</div>
			...
			<section className={styles.zitatSection}>
				...
				<blockquote className={styles.containerZitat}>um eine Idee zu verwirklichen.</blockquote>
				<cite className={styles.containerQuelle}>Larry Page, Mitbegründer von Google</cite>
			</section>
		</main>
	);
}
